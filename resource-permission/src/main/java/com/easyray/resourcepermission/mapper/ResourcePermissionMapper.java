...
public interface ResourcePermissionMapper extends EasyrayBaseMapper<ResourcePermission> {
    ...
    @Select("select distinct sys_resource_permission.*\n" +
            ...
            "        sys_user_role.user_id = ${userId} and (scope = ${@com.easyray.baseapi.constant.ActionScopeConstant@PROJECT} || scope = ${@com.easyray.baseapi.constant.ActionScopeConstant@ENTITY})))\n" +
