...
public interface ResourcePermissionMapper extends EasyrayBaseMapper<ResourcePermission> {
    ...
    @Select("select distinct sys_resource_permission.*\n" +
            ...
            "    or (sys_resource_permission.role_id = sys_user_tenant_role.role_id and tenant_id = #{tenantId} and\n" +
            "        sys_user_role.user_id = ${userId} and (scope = ${@com.easyray.baseapi.constant.ActionScopeConstant@TENANT} || scope = ${@com.easyray.baseapi.constant.ActionScopeConstant@ENTITY})))\n" +
